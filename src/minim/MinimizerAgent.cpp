...
alglib_minimization(const std::shared_ptr<BpCollection_Interface>& bp_intf_ptr,
	...
	final_res.initial_energy_contribs = bp_intf_ptr->energy_contribs();
	...
	final_res.final_energy_contribs = bp_intf_ptr->energy_contribs();
	//final_res._electro_E = BpCollectionElectrostaticEnergy::electrostatic_energy(final_res._optimized_bp_collection);
